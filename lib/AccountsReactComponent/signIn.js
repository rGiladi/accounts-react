  ...
  render () {
    ...
    return (
      <Fragment>
        ...
        {!hideSignUpLink && (
          <a className='signIn-link' onMouseDown={this.redirectToSignUp} style={linkStyle}>
            {texts.links.toSignUp}
          </a>
        )}
        {showForgotPasswordLink && (
          <a className='forgotPwd-link' onMouseDown={this.redirectToForgotPwd} style={linkStyle}>
