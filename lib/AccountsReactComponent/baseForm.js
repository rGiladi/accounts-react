...
class BaseForm extends Component {
  ...
  render () {
    ...
    return (
      <FormField onSubmit={(e) => e.preventDefault()} className={`ar-${currentState}`} ref={form => this.form = form}>
        ...
        {/* Submit Button  */}
        <SubmitField onClick={() => onSubmit(this.form)} text={button} />
